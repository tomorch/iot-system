...
public class Constants {
    ...
    public static final String KAFKA_TOPIC_PROP = "kafka.topic";

    public static final String PROMETHEUS_BASE_URL_PROP = "prometheus.base-url";
    public static final String PROMETHEUS_QUERY_PATH_PROP = "prometheus.query.path";
    public static final String PROMETHEUS_WRITE_PATH_PROP = "prometheus.write.path";
